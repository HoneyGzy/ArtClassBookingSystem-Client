<template>
  <div class="booking-management">
    <el-table :data="bookings" style="width: 100%" :row-class-name="tableRowClassName" empty-text="您暂无预约的学生">
...
export default {
  ...
  methods: {
    fetchCourses() {
      axios.get('http://localhost:3000/api/getInfocourseregistration', {
        params: {
    ...
    handleManageBooking(row) {
      ...
      this.form.username = row.username; // 添加这行
